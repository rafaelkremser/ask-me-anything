		...
		r.Route("/rooms", func(r chi.Router) {
			...
			r.Route("/{room_id}", func(r chi.Router) {
				...
				r.Route("/messages", func(r chi.Router) {
					...
					r.Get("/", a.handleFetchRoomMessages)
...
func (h apiHandler) handleFetchRooms(w http.ResponseWriter, r *http.Request) {
...
func (h apiHandler) handleFetchRoomMessages(w http.ResponseWriter, r *http.Request) {
